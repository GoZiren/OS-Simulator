...
public:
    ...
    std::string ls_r(bool detail = false) const;
	 ...
	 */
    bool cat(std::string name,std::string &result) const;
	 ...
	 */
    bool open(std::string name,std::string &result);
